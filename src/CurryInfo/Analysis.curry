...
analyseWithCASS :: (ErrorMessage a, Path a) => Options -> Package -> Version -> Module -> String -> String -> String -> (String -> a) -> IO (Maybe String)
...
analyseUnsafeModuleWithCASS opts pkg vsn m = do
    analyseWithCASS opts pkg vsn m m "UnsafeModule" "cass-unsafemodule" (CurryModule pkg vsn)
...
analyseDeterministicWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "Deterministic" "cass-deterministic" (CurryOperation pkg vsn m)
...
analyseDemandWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "Demand" "cass-demand" (CurryOperation pkg vsn m)
...
analyseIndeterministicWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "Indeterministic" "cass-indeterministic" (CurryOperation pkg vsn m)
...
analyseSolCompleteWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "SolComplete" "cass-solcomplete" (CurryOperation pkg vsn m)
...
analyseTerminatingWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "Terminating" "cass-terminating" (CurryOperation pkg vsn m)
...
analyseTotalWithCASS opts pkg vsn m o = do
    analyseWithCASS opts pkg vsn m o "Total" "cass-total" (CurryOperation pkg vsn m)
